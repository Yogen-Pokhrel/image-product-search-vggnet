...
def load_custom_model():
  ...
  classification_model  = load_model("/Users/gauravneupane/Documents/ml/projects/image_retrieval/models/classification_deepfasthion_v2.keras")
  print(classification_model.get_config())
